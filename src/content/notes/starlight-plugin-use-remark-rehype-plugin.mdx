...
This guide will walk you through the process of using a [remark](https://github.com/remarkjs/remark) or [rehype](https://github.com/rehypejs/rehype) plugin in a Starlight plugin, allowing you to extend the Markdown and HTML processing capabilities of Starlight.
...
const remarkStarlightPluginExample: Plugin<[], Root> = function () {
  return function (tree) {
    // Do the default tasks of the remark plugin.
    // ...
  }
}
```
