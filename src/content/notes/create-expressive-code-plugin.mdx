...
description: Learn how to create a custom Expressive Code plugin to report incorrect code blocks by adding a link after them to create a new issue on GitHub.
...
This hook allows for modifying the rendered code block after it has been processed by Expressive Code using the [`renderData`](https://expressive-code.com/reference/plugin-hooks/#renderdata) object.
