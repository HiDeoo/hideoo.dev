...
By convention, virtual modules are prefixed with `virtual:` and can be imported in your code like any other module.
...
To fix this, a [TypeScript declaration file](https://www.typescriptlang.org/docs/handbook/declaration-files/introduction.html) can be created to declare the virtual module and its exports.
