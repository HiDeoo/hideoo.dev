---
title: Add custom social links to Starlight
description: Learn how to add custom social links to a Starlight website header.
publishDate: 2023-11-27
---

[Starlight](https://starlight.astro.build) has built-in support for displaying many social links to the website header using the Starlight [`social`](https://starlight.astro.build/reference/configuration/#social) configuration option.
...
Using [component overrides](https://starlight.astro.build/guides/overriding-components/), you can add custom social links to Starlight like the last one in the following example:
...
:::note
Importing and rendering the built-in `<SocialIcons/>` component allows you to display the default social links supported by Starlight in your custom component.
:::
...
<a href="https://example.com" rel="me" class="sl-flex">
  <span class="sr-only">Custom Social</span>
  <svg
    aria-hidden="true"
    fill="currentColor"
    height="16"
