...
Built upon the [Content Collections API](https://docs.astro.build/en/guides/content-collections/), the Content Layer API is designed to be more flexible and powerful and is available behind an experimental flag starting with Astro 4.14.

At the time of writing, [Starlight](https://starlight.astro.build) does not yet support the Content Layer API for documentation pages but you can still use it in a Starlight project.

This guide will show you how to use this new experimental feature to create a page in your Starlight documentation website listing the recent GitHub releases for a specific repository.
...
To get started with the Content Layer API, you will need to enable the experimental flag in your `astro.config.mjs` file:
