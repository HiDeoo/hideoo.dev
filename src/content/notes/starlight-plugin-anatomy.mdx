...
The optional `i18n:setup` plugin internationalization setup function can be used to [inject custom translation strings](/notes/starlight-plugin-use-custom-translation-strings), allowing you to provide localized text for the plugin's features.
...
Even though this is a great way to get started with Starlight plugins, you will most likely want to create a dedicated package for the plugin, allowing you to share it with others and reuse it in multiple Starlight projects.
