...
Multiple hooks are available in Starlight plugins, allowing you to define the plugin's behavior, inject custom translation strings, and more.
...
The optional `i18n:setup` plugin internationalization setup function can be used to [inject custom translation strings](/notes/starlight-plugin-use-custom-translation-strings), allowing you to provide localized text for your plugin's features.

## Create a Starlight plugin

As showcased in the previous sections, writing a Starlight plugin is as simple as creating a JavaScript object in your Starlight configuration.
Even though this is a great way to get started with Starlight plugins, you will most likely want to create a dedicated package for your plugin, allowing you to share it with others and reuse it in multiple Starlight projects.
